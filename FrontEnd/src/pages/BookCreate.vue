...
const createBook = async () => {
  ...
  try {
    ...
    const isbnExists = existingBooks.some((book: any) => book.isbn === form.isbn)
    if (isbnExists) {
      errors.isbn = 'ISBN já está cadastrado'
      return
    }
    ...
    localStorage.setItem('library-books', JSON.stringify(existingBooks))
