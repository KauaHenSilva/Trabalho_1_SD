        ...
        <div class="book-header">
          ...
          <div class="book-main-info">
            ...
            <div class="book-meta">
              ...
              <span v-if="book.genre" class="meta-item">🏷️ {{ book.genre }}</span>
            </div>
          </div>
        ...
        <div class="book-details">
          <div class="detail-section">
            ...
            <div class="detail-grid">
              ...
              <div v-if="book.genre" class="detail-item">
                <label>Gênero:</label>
...
const loadBook = () => {
  try {
    ...
    book.value = books.find((b: Book) => b.id === bookId) || null
  } catch (error) {
...
const deleteBook = () => {
  ...
  try {
    const books = JSON.parse(localStorage.getItem('library-books') || '[]')
    const updatedBooks = books.filter((b: Book) => b.id !== book.value!.id)
